    ...
    KNOWN_SCHEDULE = {
        ...
        '2020-03-16': {'2020-03-16': [
            Game(home='Boston Bruins',
                 ...
                 home_score=0,
                 away_score=0,
                 time=datetime.strptime('2020-03-16T23:00:00+0000', TIME_FMT),
                 type=GameType.REGULAR,
            ...
            Game(home='Detroit Red Wings',
                 ...
                 home_score=0,
                 away_score=0,
                 time=datetime.strptime('2020-03-16T23:30:00+0000', TIME_FMT),
                 type=GameType.REGULAR,
                 status=GameStatus.POSTPONED,
                 last_play=None),
            Game(home='Arizona Coyotes',
                 away='Dallas Stars',
                 home_score=0,
                 away_score=0,
                 time=datetime.strptime('2020-03-17T02:00:00+0000', TIME_FMT),
                 type=GameType.REGULAR,
                 status=GameStatus.POSTPONED,
                 last_play=None),
        ]}
